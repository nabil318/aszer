...
<body>
    ...
    <form id="qcm-form" method="POST" action="calcule_score.php">
        <div id="questions-container">
            <?php foreach ($questions as $i => $question) { ?>
                <div class="question-div" id="question-<?php echo $i; ?>" data-correct="<?php echo htmlspecialchars($question['reponse_correcte']); ?>" data-zone="<?php echo htmlspecialchars($question['zone_correcte']); ?>">
                    <?php if ($i == 1) { ?>
    ...
    <script>
        ...
        function validateQuestion(questionId) {
            ...
            if (type === 'radio') {
                ...
                // QRM : Question à réponses multiples (Checkbox)
                let correctCount = 0;
        ...
        function disablePreviousQuestionInputs(questionId) {
            const previousQuestionId = questionId - 1; // Identifie la question précédente
            if (previousQuestionId > 0) { // Vérifie que la question précédente existe
