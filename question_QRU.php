...
if ($id) {
    ...
    if ($QI) {
        ...
        $enonce = nl2br(htmlspecialchars($QI['enonce']));
        $propositions = [
            'prop1' => nl2br(htmlspecialchars($QI['prop1'])),
            'prop2' => nl2br(htmlspecialchars($QI['prop2'])),
            'prop3' => nl2br(htmlspecialchars($QI['prop3'])),
            'prop4' => nl2br(htmlspecialchars($QI['prop4'])),
            'prop5' => nl2br(htmlspecialchars($QI['prop5'])),
            'prop6' => nl2br(htmlspecialchars($QI['prop6'])),
            'prop7' => nl2br(htmlspecialchars($QI['prop7'])),
            'prop8' => nl2br(htmlspecialchars($QI['prop8'])),
            'prop9' => nl2br(htmlspecialchars($QI['prop9'])),
            'prop10' => nl2br(htmlspecialchars($QI['prop10'])),
        ];
        $reponse_correcte = $QI['reponse_correcte'];  // La réponse correcte (ex : "1,3")
        $correction = nl2br(htmlspecialchars($QI['correction']));
        $commentaires = [
            'commentaire_prop1' => nl2br(htmlspecialchars($QI['commentaire_prop1'])),
            'commentaire_prop2' => nl2br(htmlspecialchars($QI['commentaire_prop2'])),
            'commentaire_prop3' => nl2br(htmlspecialchars($QI['commentaire_prop3'])),
            'commentaire_prop4' => nl2br(htmlspecialchars($QI['commentaire_prop4'])),
            'commentaire_prop5' => nl2br(htmlspecialchars($QI['commentaire_prop5'])),
            'commentaire_prop6' => nl2br(htmlspecialchars($QI['commentaire_prop6'])),
            'commentaire_prop7' => nl2br(htmlspecialchars($QI['commentaire_prop7'])),
            'commentaire_prop8' => nl2br(htmlspecialchars($QI['commentaire_prop8'])),
            'commentaire_prop9' => nl2br(htmlspecialchars($QI['commentaire_prop9'])),
            'commentaire_prop10' => nl2br(htmlspecialchars($QI['commentaire_prop10'])),
        ];
...
<body>
    ...
    <div id="question">
        ...
        <form method="POST">
            <?php
            // Affichage dynamique des propositions avec radio buttons
            ...
            foreach ($propositions as $key => $prop) {
                if (!empty($prop)) {
                    ...
                    echo "<label class='$class'>
                            <input type='radio' name='reponse' value='$i' $checked> $letter. " . htmlspecialchars($prop) . "
                        </label>";
